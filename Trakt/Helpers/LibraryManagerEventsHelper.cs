    ...
    internal class LibraryManagerEventsHelper
    {
        ...
        private async Task OnQueueTimerCallbackInternal()
        {
            ...
            foreach (var traktUser in Plugin.Instance.PluginConfiguration.TraktUsers)
            {
                ...
                {
                    _logger.LogInformation("{n} movie deletes to process", queuedMovieDeletes.Count);
                ...
                {
                    _logger.LogInformation("{n} Movie Adds to Process", queuedMovieAdds.Count);
                ...
                {
                    _logger.LogInformation("{n} Episode Deletes to Process", queuedEpisodeDeletes.Count);
                ...
                {
                    _logger.LogInformation("{n} Episode Adds to Process", queuedEpisodeAdds.Count);
                ...
                {
                    _logger.LogInformation("{n} Series Deletes to Process", queuedMovieDeletes.Count);
